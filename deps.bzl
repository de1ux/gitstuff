...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:53KDo64C1z/h/d/stCYCPY69bt/OSwjq5KpFNwi+zB4=",
        version = "v0.5.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:lH3yrYMhdpeqX9y5Ep1u7DejyHy7NSQg9qrBjF9dFT4=",
        version = "v0.12.79",
    )
    go_repository(
    ...
    go_repository(
        name = "dev_atomicgo_assert",
        importpath = "atomicgo.dev/assert",
        sum = "h1:FiKeMiZSgRrZsPo9qn/7vmr7mCsh5SZyXY4YGYiYwrg=",
        version = "v0.0.2",
    )
    go_repository(
        name = "dev_atomicgo_cursor",
        importpath = "atomicgo.dev/cursor",
        sum = "h1:H6XN5alUJ52FZZUkI7AlJbUc1aW38GWZalpYRPpoPOw=",
        version = "v0.2.0",
    )
    go_repository(
        name = "dev_atomicgo_keyboard",
        importpath = "atomicgo.dev/keyboard",
        sum = "h1:tOsIid3nlPLZ3lwgG8KZMp/SFmr7P0ssEN5JUsm78K8=",
        version = "v0.2.9",
    )
    go_repository(
        name = "dev_atomicgo_schedule",
        importpath = "atomicgo.dev/schedule",
        sum = "h1:nTthAbhZS5YZmgYbb2+DH8uQIZcTlIrd4eYr3UQxEjs=",
        version = "v0.1.0",
    )
    go_repository(
